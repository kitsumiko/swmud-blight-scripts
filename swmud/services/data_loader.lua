-- Data file loading service

local DataLoader = {}

function DataLoader.read_file(file_name)
...
function DataLoader.file_to_lookup_table(file_name, lookup_column, output_table, separator)
  local data = DataLoader.read_file(file_name)
  if data == nil then
    return nil
  end
  local lines = {}
...
read_data_file = DataLoader.read_file
data_file_to_lookup_table = DataLoader.file_to_lookup_table
